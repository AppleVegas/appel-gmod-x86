...
namespace Interfaces
{
	namespace _I
	{
		...
		ICvar*						cvar;
		StringTable* EStringTable;
		CNetworkStringTableContainer* INetworkStringTableContainer;
	...
	CPlayerResource* CCPlayerResource() { return _I::PlayerResource; }
	...
	CClientState* ClientState() { return _I::ClientState; }
	CNetworkStringTableContainer* NetworkStringTableContainer() { return _I::INetworkStringTableContainer; }
	...
	void _SetupInterfaces()
	{
		...
		_I::PlayerResource = (CPlayerResource*)(Util::Pattern::FindPattern("client.dll", "A1 ?? ?? ?? ?? 85 C0 74 06") + 1);
		...
		//print("0x%X\n", _I::PlayerResource);
		_I::EStringTable = (StringTable*)_GetInterface("engine.dll", "VEngineClientStringTable001");
		...
		_I::INetworkStringTableContainer = *(CNetworkStringTableContainer**)_GetInterface("engine.dll", "VEngineClientStringTable001");
		//_I::ClientState = _I::BaseClientState;
	...
	void _printInterfaceAddresses()
	{
		...
		// Engine
		printColor(COLOR_YELLOW, "[SYSTEM] ");
		printColor(COLOR_PURPLE, "IEngine               = ");
		print("0x%X\n", _I::engine);

		printColor(COLOR_YELLOW, "[SYSTEM] ");
		printColor(COLOR_PURPLE, "StringTable               = ");
		print("0x%X\n", _I::INetworkStringTableContainer);
		// ClientEntityList
		printColor(COLOR_YELLOW, "[SYSTEM] ");
