...
ImGuiStyle::ImGuiStyle()
{
	...
	ImGui::StyleColorsAppel(this);
}

void ImGui::StyleColorsAppel(ImGuiStyle* dst)
{
...
bool ImGui::Hotkey(const char* label, int* k, const ImVec2& size_arg)
{
	...
	ImU32 col;
	col = GetColorU32((hovered) ? ImGuiCol_ButtonActive : hovered ? ImGuiCol_ButtonHovered : ImGuiCol_Button);
	...
	RenderTextClipped(frame_bb.Min + style.FramePadding, frame_bb.Max - style.FramePadding, buf_display, NULL, &label_size, style.ButtonTextAlign, &total_bb);
